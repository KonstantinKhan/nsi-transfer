...
internal class PolynomAuthHttpClient : PolynomBaseHttpClient, IPolynomHttpClient
{
    public string ClientKey => PolynomHttpClientKeys.Auth;

    public PolynomAuthHttpClient(HttpClient httpClient, ILogger<PolynomAuthHttpClient> logger)
